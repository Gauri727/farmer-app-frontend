...
const CustomTabBar: React.FC<BottomTabBarProps> = ({ state, descriptors, navigation }) => {
  ...
  const tabs = [
    ...
    { isCenter: true },
    { routeName: 'WCDTab', label: 'WCD', activeIcon: 'shield-checkmark' as const, inactiveIcon: 'shield-checkmark-outline' as const },
...
export const MainTabs: React.FC = () => (
  ...
  >
    ...
    <Tab.Screen name="WCDTab" component={WCDStack} />
