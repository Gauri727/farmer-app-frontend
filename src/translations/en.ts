...
export const en: Record<string, string> = {
  ...
  "adminPanel": "Admin",
  "guest": "Guest",
  "signInSaveSchemes": "Sign in to save schemes and applications",
  "adminAccessRequired": "Admin access required",
  "adminAccessSub": "Sign in with an admin or moderator account to view this panel.",
  "signIn": "Sign in",
  "adminAccessGranted": "ADMIN ACCESS GRANTED",
  "welcomeAdmin": "Welcome, Administrator",
  "adminDashboardSub": "System overview and management dashboard.",
  ...
  "tapToSpeakSub": "Ask anything in your language. Available in 3 regional languages.",
  "pill12Languages": "3 Languages",
