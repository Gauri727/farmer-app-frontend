        ...
        style={[
          styles.fullScreenOverlay,
          {
            backgroundColor: isDesktop
              ? (isDarkMode ? 'rgba(15, 23, 42, 0.85)' : 'rgba(0, 0, 0, 0.45)')
              : (isDarkMode ? themeColors.background : Colors.white),
          },
        ]}
      >
        <KeyboardAvoidingView
        ...
        >
          <View
            style={[
              ...
              isDesktop && styles.desktopChatbotContainer,
              { backgroundColor: isDarkMode ? themeColors.background : Colors.white },
            ]}
          >
            ...
            <View
              style={[
                styles.header,
                {
                  ...
                  paddingHorizontal: isSmallScreen ? 8 : (isDesktop ? 20 : 12),
                },
              ]}
            >
              <View style={styles.maxContainerRow}>
                <TouchableOpacity
                  style={[
                    styles.backButton,
            ...
            <View style={[styles.content, { backgroundColor: isDarkMode ? themeColors.background : Colors.white }]}>
              <ScrollView
                ...
                contentContainerStyle={[
                  ...
                  { paddingHorizontal: isSmallScreen ? 14 : (isDesktop ? 24 : 20) },
                ]}
                showsVerticalScrollIndicator={false}
                keyboardShouldPersistTaps="handled"
              >
                <View style={styles.maxContainerCol}>
              ...
              >
                <View style={styles.maxContainerRowInput}>
                  <TextInput
                    value={messageText}
