...
export const AboutScreen: React.FC<any> = ({ navigation }) => (
  <View style={styles.container}>
    ...
    <ScrollView contentContainerStyle={styles.content}>
      ...
      {/* APP ICON — changed from leaf icon to assets/icon.png */}
      <Image
      ...
      <Text style={styles.bodyText}>
        Farmer AI Voice Assistant is designed to help Indian farmers
        discover government schemes, check eligibility, get agricultural
        guidance, and access information in their preferred language.
        {'\n\n'}
        Built with ❤️ for Indian farmers.
        {'\n\n'}
        Our mission is to bridge the information gap and empower farmers
        with AI-powered assistance in 12 regional languages.
      </Text>
    </ScrollView>
  </View>
);
  ...
  <View style={styles.container}>
    ...
    <ScrollView contentContainerStyle={styles.content}>
      <Text style={styles.bodyText}>
        ...
        Your voice recordings are processed securely and not shared with
        third parties.
        {'\n\n'}
  ...
  <View style={styles.container}>
    ...
    <ScrollView contentContainerStyle={styles.content}>
      <Text style={styles.bodyText}>
        ...
        • The app provides information about government schemes and
        ...
        We provide information as-is. We are not responsible for decisions
        made based on the information provided by our AI assistant.
        Government scheme details are sourced from publicly available data
...
export const LoadingScreen: React.FC = () => (
  <View style={styles.centerContainer}>
    ...
    {/* Loading logo remains unchanged */}
...
const styles = StyleSheet.create({
  ...
  /*
   * ABOUT SCREEN APP ICON
   * Uses the project's actual assets/icon.png
   */
  aboutLogo: {
    width: 72,
    height: 72,
  ...
  /*
   * LOADING SCREEN LOGO
   * Kept exactly as the original leaf logo.
   */
  logoContainer: {
    width: 72,
    height: 72,
